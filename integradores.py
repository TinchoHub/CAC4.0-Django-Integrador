...
class Persona:
    ...
    def DNI(self, nuevo_DNI):
        nuevo_DNI_int=get_int(nuevo_DNI)
        if (nuevo_DNI_int>1000000) and (nuevo_DNI_int<100000000):
            self._DNI=nuevo_DNI_int
        else:
            raise ValueError("El DNI debe estar comprendido entre 1.000.000 y 100.000.000")
...
empleado1 = CuentaJoven("Pepe",25,35678910,1500,25)
empleado1.mostrar()
